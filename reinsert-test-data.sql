-- Script pour réinsérer les données de test dans PostgreSQL
...
-- Réinsérer les données de test pour les factures (événements futurs)
...
-- Réinsérer les données de test pour les devis (événements futurs)
...
UNION ALL
SELECT 'Éléments factures' as type, COUNT(*) as count FROM invoice_items
UNION ALL
SELECT 'Éléments devis' as type, COUNT(*) as count FROM quote_items; 